...
6. **Stop when:** the measured goal is met; further gains need language/runtime recipes (hand off to `*-dev`, overlay, project `AGENTS.md`, or optional third-party packs — do not paste those recipes into this file); or evidence does not support the change.
